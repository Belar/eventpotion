	...
	<div class="row">
		<div class="col-md-8">
			<div id="reg-login-forms">	
				<h3>Add article</h3>			
				<div class="form-body">
					{{ Form::open(array('url' => array('/blog/edit', $post->id), 'role' => 'form', 'method'=>'put', 'files'=> true)) }}
						<ul class="errors">
					...
					<div class="form-step">		
						<div class="form-group">
							...
							{{ Form::textarea('content', $post->content, array('id'=>'post_content', 'class'=>'form-control textarea-about')) }}
						</div>
						<div class="form-group">
							{{ Form::label('tags', 'Tags') }} 
							{{ Form::text('tags', $post->tags , array('class'=>'form-control')) }}
							<p><small>Separate tags with commas.</small></p>
						</div>
					</div>
						<div class="checkbox">
						{{ Form::checkbox('public_state', $post->public_state, Input::old('public', true) ) }}   <p>Public <small>(Uncheck to save an event as a draft.)</small>
						</div>
