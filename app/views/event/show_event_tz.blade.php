        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-md-3 col-xs-6">
                    <p><i class="fa fa-calendar"></i> {{ Timezone::convert($event->start_date, Sentry::getUser()->timezone, 'd M \'y') }} </p>
                    <p><i class="fa fa-clock-o"></i> {{ Timezone::convert($event->start_date, Sentry::getUser()->timezone, 'H:i') }}</p>
                </div>

                <div class="col-md-2 col-xs-6">
                    <p><i class="red fa fa-calendar"></i> {{ Timezone::convert($event->finish_date, Sentry::getUser()->timezone, 'd M \'y') }}</p>
                    <p><i class="red fa fa-clock-o"></i> {{ Timezone::convert($event->finish_date, Sentry::getUser()->timezone, 'H:i') }}</p>
                </div>
