	...
	<div class="row">
		<div class="col-md-8">
			<div id="reg-login-forms">	
				<h3>Add show</h3>			
				<div class="form-body">
					{{ Form::open(array('url' => 'show/add', 'role' => 'form')) }}
						<ul class="errors">
					...
					<div class="row">
						<div class="form-group col-md-3">
							...
							{{ Form::text('show_icon', '', array('class'=>'form-control')) }}
						</div>
					</div>
						<div class="form-group">
					...
					<div class="form-step">		
						...
						<div class="form-group">
							...
							{{ Form::text('people', '', array('class'=>'form-control')) }}
						</div>
					</div>
					<div class="form-step">		
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div id="stream_urls">
							{{ Form::text('stream', '', array('class'=>'form-control stream_url')) }}
						...
						<div class="form-group vods-input">
							...
							{{ Form::textarea('vods', '', array('id'=>'about_event', 'class'=>'form-control textarea-vods')) }}
						</div>
						<div class="form-group">
