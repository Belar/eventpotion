            ...
            <div class="table-responsive">
                <table class="table table-striped table-condensed">
                    ...
                    <tr>
                        ...
                        <td class="hidden-xs"><span data-toggle="tooltip" data-placement="left" data-original-title="{{ Timezone::convert($show->air_date, Sentry::getUser()->timezone, 'H:i') }}">{{ Timezone::convert($show->air_date, Sentry::getUser()->timezone, 'd M \'y') }}</td>
